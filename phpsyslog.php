...
while($row = mysql_fetch_assoc($result)){
        ...
        echo "<tr ".$tr_class.">\n";
  echo "<td class='f0' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['id'] . "</span></td>";          
  echo "<td class='f1' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['date'] . "</span></td>";
  echo "<td class='f2' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['task'] . "</span></td>";
  echo "<td class='f3' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['problem'] . "</span></td>";
  echo "<td class='f4' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['solution'] . "</span></td>";
  echo "<td class='f5' overflow='hidden' align='center' style='table-layout:fixed'><span>" . $row['user'] . "</span></td>";
...
echo '<center><hr><div class="pagination" width="700px">'."\n";
echo $prev_link;
...
function columnSortArrows($field,$text,$currentfield=null,$currentsort=null){        
        ...
        return '<a href="?'.$orderquery.'&'.$sortquery.'&a=syslog">'.$text.'</a> '. $sortarrow;        
