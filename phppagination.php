...
class Pagination {
        ...
        function showNext($totalrows,$page,$limit,$text="next &raquo;"){        
                ...
                if($page < $numofpages){
                        $page++;
                        $next_link = '<div class="page-link"><a href="?page='.$page.'&'.$query_string.'a=syslog">'.$text.'</a></div>';
                }
        ...
        function showPrev($totalrows,$page,$limit,$text="&laquo; prev"){        
                ...
                if($page > 1){
                        $page--;
                        $prev_link = '<div class="page-link"><a href="?page='.$page.'&'.$query_string.'a=syslog">'.$text.'</a></div>';
                }
